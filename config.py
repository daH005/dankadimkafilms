...
INSULTS = ['пидр', 'хуй', 'гандон', 'сука', 'блядь', 'козёл', 'мразь',
           'казёл', 'казел', 'козел', 'блять', 'урод', 'ублюдок', 'пидор',
           'пидарас', 'гей', 'тварь', 'тварина', 'сучара', 'bitch',
           'suka', 'еблан', 'ебланище', 'ебан', 'уебан', 'ебло', 'залупа',
           'хуйня', 'хуита', 'хуета', 'жопа', 'животное']